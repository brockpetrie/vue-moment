...
var vueMoment = {
  install: function install(App, options) {
    var _moment = options && options.moment ? options.moment : moment;

    var $filters = {
      moment: function moment$$1() {
        var arguments$1 = arguments;
            ...
            case 'from':
              {
                ...
                */
                ...
                if (_moment(args[0]).isValid()) { from = _moment(args.shift()); }
            ...
            case 'diff':
              {
                ...
                */
                ...
                var referenceTime = _moment();
                var units = '';
                var float = false;

                if (_moment(args[0]).isValid()) {
                  // If valid, assume it is a date we want the output computed against.
                  referenceTime = _moment(args.shift());
            ...
            case 'calendar':
              {
                ...
                */
                ...
                var _referenceTime = _moment();
                var formats = {};

                if (_moment(args[0]).isValid()) {
                  // If valid, assume it is a date we want the output computed against.
                  _referenceTime = _moment(args.shift());
                } else if (args[0] === null || args[0] === 'now') {
                  // If null or 'now', remove argument and proceed with default referenceTime.
                  args.shift();
                }
      ...
      duration: function duration() {
        ...
        */
        ...
        function createDuration(time) {
          ...
          var result = _moment.duration.apply(_moment, _toConsumableArray(time));
    ...
    Object.defineProperties(App.config.globalProperties, {
      ...
      $filters: {
        value: _extends({}, App.config.globalProperties.$filters || {}, $filters),
        writable: true
      }
    });

    App.provide('moment', _moment);
    App.provide('moment-filters', $filters);
    App.moment = _moment;
  }
};
